...
import com.myecommerceexception.Dummy;
...
public class ProductMain {
	...
	private static void createMenu() {
		...
		// Implements Search Products by Name
		System.out.println("Enter 5 to  Search Products by Name");
		// Delete a Product for a Product Id
		System.out.println("Enter 6 to  Delete a Products by Id");
	...
	private static void deleteProduct(ProductService productService) {
		...
		if(dto != null) {
			...
			System.out.println("No Product Found with the Id " + productId);
	...
	private static void getAllProducts(ProductService productService) {
		 ...
		 * products.get(count).getDescription());
		 * 
		 * }
		 * 
		 * } catch (Exception ex) { System.out.println("Some error ocurred"); }
		 */
